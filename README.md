...
Фронтенд &mdash; Vue.js, отображение таблиц, одна страница на логический элемент представления.

Бэкенд &mdash; Spring Boot, прямой маппинг запросов на базу данных.
